  ...
  <div class="container w-full mx-auto mt-2 border-2 border-purple-400">
      ...
      <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <div class="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
            <img
              alt="Desk"
              src="../assets/image/logoAgenda.jpg"
              class="transform scale-300 object-cover rounded-lg"

            />
          </div>

          <div class="lg:py-24">
            <h2 class="text-3xl font-bold sm:text-4xl">Agenda Empleado</h2>
            <br>
            <p class="mt-4 text-gray-600">
              Esta página te permitira ver tu calendario laboral de una manera sencilla,además 
              podras solicitar cambio de fechas en jornadas de descanso laboral..una forma de poder solicitar permisos de manera online.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="mt-0">
      <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div class="mt-0 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <div class="relative h-64 overflow-hidden sm:h-80 lg:h-full">
            <img
              alt="Calendar"
              src="../assets/image/logoVacaciones.jpg"
              class="transform scale-300 object-cover  rounded-lg"
          ...
          <div class="lg:py-20">
            ...
            <article class="space-y-4 text-gray-600">
              <p>
                A través de esta página podrás tambien solicitar vacaciones ,una forma de tenerlo todo online
                con mayor rapidez de respuesta por parte de tu departamento de rrhh.
    ...
    <footer aria-label="Site Footer" class="bg-gray-100">
      <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="flex justify-center text-teal-600">
          <img
          alt="Calendar"
          src="../assets/image/logoPrincipal.png"
          class="object-cover w-32 h-32 mx-auto  rounded-lg"
        ...
        <div class="flex justify-center mt-0">
          <p class="mx-auto max-w-md text-center leading-relaxed text-gray-500">
            Consultoría especializada en ayudar a reforzar los puntos fuertes de una empresa y mejorar los puntos débiles para poder alcanzar los objetivos deseados.
          </p>
        </div>
